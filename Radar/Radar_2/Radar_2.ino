...
void Scan(int * A)
{
  ...
  Reset_HORIZONTAL(A[1]+20);  
  Reset_VERTICAL(A[0]+10);  
}
...
void loop()
{
  ...
  if(Serial.available())
  {
    ...
    {
      Scan(A);
      Serial.print("Vertical= ");Serial.print(A[0]); Serial.print("\t");Serial.print("Horizontal= ");Serial.println(A[1]);
    }
    
    else
    {
      Reset_HORIZONTAL(0); Reset_VERTICAL(A[0]);  
    }
  }
  */
}
